...
- **LLM/로그인(Antigravity·Google)**: [설치](docs/antigravity/install.md) · [agy 명령어 모음](docs/antigravity/commands.md) · [아키텍처](docs/antigravity/architecture.md) · [조사](docs/antigravity/research.md)
